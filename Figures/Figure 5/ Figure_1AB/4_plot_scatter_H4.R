...
smr_table_disease <- fread("/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/sta_output_final_1Mb/disease_traits/table_H4_newGWAS/smr_table.csv")
...
smr_table_blood <- fread("/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/sta_output_final_1Mb/blood_traits/table_H4/smr_table.csv")
...
disease_names <- c("alzheimer_GCST90027158", "breastca_GCST004988", "colorectalca_GCST90129505", "covid_GCST011071", "ibd_liu2023", 
                   ...
                   "nephrotic_GCST90258619", "kiryluk_IgAN", "asthma", "ms", "t1dm", "cd", "ibd", "uc")
...
coloc_table$label <- ifelse(coloc_table$V1 %in% c("parkinson_GCST009325", "asthma", "ibd", "lymphocyte_percent", "c_reactive_protein", "neutrophil_percent"), mapping[coloc_table$V1], "")
...
ggsave("/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/sta_output_final_1Mb/figure_H4_newGWAS/coloc_scatter_label.png", p, width = 5.5, height = 4, dpi = 300)
...
p <- ggplot(coloc_table, aes(x = eQTL_prop, y = caQTL_prop, color = group)) + geom_point() + scale_color_manual(values = c("disease" = "#ecc15a", "blood_count" = "#57a7b5", "blood_serum" = "#417e41"), 
  ...
  geom_abline(slope = 1, intercept = 0, linetype = "dotted", color = "black") + theme_bw() + theme(panel.grid = element_blank(), axis.title = element_text(size = 14), axis.text = element_text(size = 12), 
                                                                                                   plot.title = element_text(size = 16, hjust = 0.5, face = "bold")) + xlim(0, 60) + ylim(0, 72) +
  labs(title = "coloc", x = "GWAS loci proportion - eQTL %", y = "GWAS loci proportion - caQTL %", color = "Group")
ggsave("/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/sta_output_final_1Mb/figure_H4_newGWAS/coloc_scatter_label_clean.png", p, width = 5.5, height = 4, dpi = 300)
...
smr_table$label <- ifelse(smr_table$V1 %in% c("parkinson_GCST009325", "asthma", "ibd", "lymphocyte_percent", "c_reactive_protein", "neutrophil_percent"), mapping[smr_table$V1], "")
...
ggsave("/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/sta_output_final_1Mb/figure_H4_newGWAS/smr_scatter_label.png", p, width = 5.5, height = 4, dpi = 300)
...
p <- ggplot(smr_table, aes(x = eQTL_prop, y = caQTL_prop, color = group)) + geom_point() + scale_color_manual(values = c("disease" = "#ecc15a", "blood_count" = "#57a7b5", "blood_serum" = "#417e41"), 
  ...
  geom_abline(slope = 1, intercept = 0, linetype = "dotted", color = "black") + theme_bw() + theme(panel.grid = element_blank(), axis.title = element_text(size = 14), axis.text = element_text(size = 12), 
                                                                                                   plot.title = element_text(size = 16, hjust = 0.5, face = "bold")) + xlim(0, 60) + ylim(0, 72) +
  labs(title = "SMR", x = "GWAS loci proportion - eQTL %", y = "GWAS loci proportion - caQTL %", color = "Group")
ggsave("/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/sta_output_final_1Mb/figure_H4_newGWAS/smr_scatter_label_clean.png", p, width = 5.5, height = 4, dpi = 300)
