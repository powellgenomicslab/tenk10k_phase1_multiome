...
plink_result_dir <- "/g/data/ei56/jf1058/TEMP/Brenner_copy/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/plink_output/disease_traits/"
eQTL_result_basedir <- "/g/data/ei56/jf1058/TEMP/Brenner_copy/tenk10k_phase1/SMR/output/main_analyses_NewGenotypes/preprocessing_eQTL_1Mb/"
caQTL_result_basedir <- "/g/data/ei56/jf1058/TEMP/Brenner_copy/tenk10k_phase1/SMR/output/main_analyses_NewGenotypes/preprocessing_caQTL_rawID/"

eQTL_coloc_result_basedir <- "/g/data/ei56/jf1058/TEMP/Brenner_copy/tenk10k_phase1/SMR/coloc_SMR_compare/Coloc_1Mb/Coloc_Results/"
caQTL_coloc_result_basedir <- "/g/data/ei56/jf1058/TEMP/Brenner_copy/tenk10k_phase1/SMR/coloc_SMR_compare/Coloc_finalresults/disease_caQTL_GWAS/"
eQTL_SMR_result_basedir <- "/g/data/ei56/jf1058/TEMP/Brenner_copy/tenk10k_phase1/SMR/output/main_analyses_NewGenotypes/GWAS_eQTL_1Mb/"
caQTL_SMR_result_basedir <- "/g/data/ei56/jf1058/TEMP/Brenner_copy/tenk10k_phase1/SMR/output/main_analyses_NewGenotypes/GWAS_run_rawID/"
...
for (cell_type in cell_type_list) {
  ...
  eQTL_SMR_result_dir <- paste0(eQTL_SMR_result_basedir, "disease_traits/", trait, "/", cell_type, "/")
  ...
  for (chr in seq(1, 22)) {
    ...
    eQTL_df <- fread(file.path(eQTL_result_dir, paste0("Chr", chr, "_MatrixeQTL.tsv")))
...
write.csv(coloc_table, paste0("/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/sta_output_final_1Mb/disease_traits/table_H4_newGWAS/coloc_", coloc_folder_name, ".csv"), row.names = TRUE)
write.csv(smr_table, paste0("/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/sta_output_final_1Mb/disease_traits/table_H4_newGWAS/smr_", coloc_folder_name, ".csv"), row.names = TRUE)
