...
eQTL_result_basedir <- "/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/output/main_analyses_NewGenotypes/preprocessing_eQTL_1Mb/"
...
eQTL_coloc_result_basedir <- "/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/Coloc_1Mb/Blood_Coloc_Results/"
...
eQTL_SMR_result_basedir <- "/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/output/main_analyses_NewGenotypes/GWAS_eQTL_1Mb/"
...
for (cell_type in cell_type_list) {
  ...
  eQTL_SMR_result_dir <- paste0(eQTL_SMR_result_basedir, "blood_traits/", trait_fullname, "/", cell_type, "/")
...
write.csv(coloc_table, paste0("/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/sta_output_final_1Mb/blood_traits/table_H4/coloc_", trait, ".csv"), row.names = TRUE)
write.csv(smr_table, paste0("/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/SMR/coloc_SMR_compare/PLINK_clumping/sta_output_final_1Mb/blood_traits/table_H4/smr_", trait, ".csv"), row.names = TRUE)
