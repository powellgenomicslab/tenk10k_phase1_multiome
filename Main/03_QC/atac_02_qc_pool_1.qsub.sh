...
touch ./output/logs/atac_02_qc_pool_1.log
> ./output/logs/atac_02_qc_pool_1.log

# Main command and record the time&mem usage
/usr/bin/time -v $Rscript atac_02_qc.R pool_1 >> ./output/logs/atac_02_qc_pool_1.log 2>&1
