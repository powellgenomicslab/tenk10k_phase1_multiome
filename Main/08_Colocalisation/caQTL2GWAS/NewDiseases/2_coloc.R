...
results_dir <- glue("/g/data/fy54/od8037/TenK10K/ColocNew/NewDiseases/Results/{condition}/{celltype}")
...
for (chr_num in 1:22) {
    ...
    gwas_path <- glue("/g/data/fy54/od8037/TenK10K/ColocNew/NewDiseases/GWAS/{condition}/chr{chr_num}.fst")
