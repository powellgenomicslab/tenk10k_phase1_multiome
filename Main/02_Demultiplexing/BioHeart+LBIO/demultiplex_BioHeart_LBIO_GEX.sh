...
#$ -l mem_requested=22G # Memory requested per core
#$ -pe smp 24            # Request 4 CPU cores (adjust based on your needs)
#$ -l h_vmem=2G        # Set hard memory limit per core
#$ -l tmp_requested=1G # Request 20 GB of temporary space
#$ -r yes
...
BAM=/directflow/SCCGGroupShare/projects/josealq/multiome/data/ATAC/${INDEX}/outs/outs/gex_possorted_bam.bam

FASTA=/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/BioHeart_LBIO/resource/genome.fa
VIREO_OUTDIR=/directflow/SCCGGroupShare/projects/jayfan/Projects/Multiome/tenk10k_phase1/BioHeart_LBIO/output/demultiplexing/BioHeart_GEX/${INDEX}
