# caQTL mapping using TensorQTL

This folder contains the scripts for caQTL mapping with TensorQTL. The caQTL results from TensorQTL were used as the primary results in our paper.
